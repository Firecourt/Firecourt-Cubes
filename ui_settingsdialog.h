...
"    }"));
    ...
    void retranslateUi(QDialog *SettingsDialog)
    {
        ...
        // Set tab text instead of calling setTitle on QWidget
        ...
        tabWidget->setTabText(tabWidget->indexOf(audioTab), QCoreApplication::translate("SettingsDialog", "Audio", nullptr));
        ...
        tabWidget->setTabText(tabWidget->indexOf(advancedTab), QCoreApplication::translate("SettingsDialog", "Advanced", nullptr));
